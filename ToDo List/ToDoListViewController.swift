...
class ToDoListViewController: UIViewController {
    ...
    // this is the old way, toDoItems was an array of ToDoItem
//    var toDoItems: [ToDoItem] = []
    
    // here is the new way,
    // toDoItems is an object of the type ToDoItems (plural), which contains a property itemsArray that is an array of toDoItem (singular)
    ...
    override func viewDidLoad() {
        ...
        LocalNotificationManager.authorizeUserNotification(viewController: self)
...
extension ToDoListViewController: UITableViewDelegate, UITableViewDataSource, ListTableViewCellDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.delegate = self
        cell.toToItem = toDoItems.itemsArray[indexPath.row]
        return cell
    }
